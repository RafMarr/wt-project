...
<section id="booking-params" class="row mx-0 justify-content-center column-gap-md-2 p-0 mb-5">
    ...
    <div class="d-md-flex flex-column gap-2 justify-content-start col-10 col-md-3 col-xl-2 mb-3 mb-md-0 text-start">
        ...
        <input type="time" min="<?php echo HIPPODROME_OPENING_TIME ?>" max="<?php echo HIPPODROME_WEEKDAYS_LAST_BOOKING_START_TIME ?>" class="form-control is-invalid" name="start-time" id="start-time" aria-describedby="start-time-feedback" />
